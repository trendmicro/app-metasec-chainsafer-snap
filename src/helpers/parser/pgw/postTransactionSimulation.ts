...
const postTransactionSimulation: TPostTransactionSimulation = (responseBody) => {
  ...
  if (responseBody.recipient_asset_changes != null && responseBody.recipient_asset_changes.length > 0) {
...
function convertToAssetChangeParsed(assetChange: IPostTransactionSimulationAssetChangeBody): IPostTransactionSimulationAssetChangeParsed {
  ...
  if (assetChange.balance_diff != null) {
    balanceDiff = {
      ...
      originDollarValue: parserMapping<string>(assetChange.balance_diff, 'origin_dollar_value', ''),
      afterDollarValue: parserMapping<string>(assetChange.balance_diff, 'after_dollar_value', ''),
...
function convertToContractParsed(contract: IPostTransactionSimulationContractBody): IPostTransactionSimulationContractParsed {
  return {
